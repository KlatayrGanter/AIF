...
A garment can be allowing touch or barring touch. A garment is usually barring touch. [Determines touchability of underlying parts.]
...
To decide whether (clothing - a list of garments) fall over (cover - a list of cover areas) for (G - a garment):
	...
	Repeat with cloth running through clothing:
		If G is cloth or the body layer of cloth < the body layer of G, Break;
...
Some panties is usually allowing touch.
...
A bra is usually allowing touch.
...
An undershirt is usually allowing touch.
...
A swimsuit is usually allowing touch.
...
Some socks is usually allowing touch.
...
Some stockings is usually allowing touch.
...
Some pantyhose is usually allowing touch.
...
A strap-on is usually allowing touch.
...
There is also more information available in the kind listing in the IDE.
	...
	Bra (Indecent Underwear): Covers upper torso/back; allowing touch.
	Mask (Immodest Underwear): Covers face and head.
	Panties (Indecent Underwear): Covers crotch, but can be moved or ripped to reveal crotch; allowing touch; plural.
	Swimsuit (Immodest Underwear): Covers upper/lower torso, lower back/crotch, but can be moved aside to reveal upper torso area; allowing touch.
	Undershirt (Immodest Underwear): Covers upper/lower torso/back, but can be ripped to reveal upper torso; allowing touch.

	Glasses (Formal Normalwear): Covers the face; plural.
	Pantyhose (Formal Normalwear): Covers feet, leg, thigh and crotch, but can be ripped to expose crotch; allowing touch; plural.
	...
	Socks (Formal Normalwear): Covers feet; allowing touch; plural.
	Stockings (Formal Normalwear): Covers feet, leg and thigh, but can be ripped to expose thigh; allowing touch; plural.
...
The necessary access for these actions, is that all the revealed cover areas of the garment are not covered by another garment.
...
The clothing coverage check allows for some garments to be 'allowing touch', which allows these action to succeed even if the part in question is obscured by the garment.
...
Similar to touching and rubbing, the clothing coverage check here takes into account 'allowing touch' on the covering garments.
...
For simplicity sake we'll refer to something as 'covered' if the related person is wearing at least one garment whose revealed cover areas match the compared items' and the clothling level is higher on the worn item.
...
Touching is similarly calculated if atleast one cover area is not covered by any garments that are not allowing touch.
...
Note that because this only covers the tail, a person without a tail will be unable to wear it.
	...
	It is transparent. It is allowing touch.
